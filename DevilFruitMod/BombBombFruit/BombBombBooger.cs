...
namespace DevilFruitMod.BombBombFruit
{
    public class BombBombBooger : ModProjectile
    {
		...
		public override void AI()
		{
            ...
            {
				Main.PlaySound(SoundLoader.customSoundType, (int)Main.player[projectile.owner].position.X, (int)Main.player[projectile.owner].position.Y, mod.GetSoundSlot(SoundType.Custom, "Sounds/BombBombFlick"));
			}
