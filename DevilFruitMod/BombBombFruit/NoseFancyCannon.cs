...
namespace DevilFruitMod.BombBombFruit
{
    public class NoseFancyCannon : ModProjectile
    {
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(spawnLoc, projectile.velocity, mod.ProjectileType("NoseFancyCannon"), projectile.damage, projectile.knockBack, Main.myPlayer, 0f, projectile.ai[1] - 1); //Spawning a projectile
				Main.PlaySound(SoundID.Item42, projectile.position);
			}
